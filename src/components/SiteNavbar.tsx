...
export function SiteNavbar({ showSearch = false, extraLinks }: SiteNavbarProps) {
  return (
    <nav className={styles.nav}>
      <Link href="/" className={styles.logo}><strong>Pebble</strong></Link>
      {showSearch && process.env.NODE_ENV === 'production' && <Search />}
